...
% modified by Cecilia Righi - latest update: July 2026
...
% --monitor_bg: NOₓ concentration (ppb) detected by the NOₓ monitor when 
% N2O flow = 0 and Hg-lamp is on
% --bottle_bg: NOₓ concentration (ppb) detected by the NOₓ monitor during the background experiment (Hg-lamp off)
